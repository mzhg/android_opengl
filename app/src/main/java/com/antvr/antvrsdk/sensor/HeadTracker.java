...
import com.antvr.antvrsdk.sensor.model.OrientationEKF;
import com.antvr.antvrsdk.sensor.model.Vector3d;
...
public class HeadTracker implements SensorEventListener {
    ...
    public void getLastHeadView(final float[] headView, final int offset) {
        ...
        synchronized (this.mTracker) {
            ...
            final double secondsToPredictForward = secondsSinceLastGyroEvent + 1.0/300;
            //Log.e("panjieJ","im from head tracker and secondsToPredictForward is :"+secondsToPredictForward);
