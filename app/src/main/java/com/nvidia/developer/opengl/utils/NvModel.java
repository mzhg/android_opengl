...
public class NvModel {
	...
	protected final StackFloat _positions = new StackFloat();
	protected final StackFloat _normals = new StackFloat();
	protected final StackFloat _texCoords = new StackFloat();
	protected final StackFloat _sTangents = new StackFloat();
	protected final StackFloat _colors = new StackFloat();

	protected int _posSize;
	protected int _tcSize;
	protected int _cSize;

	protected final StackInt _pIndex = new StackInt();
	protected final StackInt _nIndex = new StackInt();
	protected final StackInt _tIndex = new StackInt();
	protected final StackInt _tanIndex = new StackInt();
	protected final StackInt _cIndex = new StackInt();
...
//	    vec3f r = 0.5f*(maxVal - minVal);
	    Vector3f r = (Vector3f) Vector3f.sub(maxVal, minVal, null);
		r.scale(0.5f);
