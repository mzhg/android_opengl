...
final class MatteProgram extends  BaseProgram{
    ...
    public MatteProgram() {
        ...
        int envMapIrrad = program.getUniformLocation("diffuseMap");
        int diffuseMap = program.getUniformLocation("envMapIrrad");
        ...
        GLES30.glUniform1i(envMapIrrad, 1);
        GLES30.glUniform1i(diffuseMap, 2);
