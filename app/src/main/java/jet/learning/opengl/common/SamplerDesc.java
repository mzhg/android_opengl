...
public class SamplerDesc {
	...
	public int minFilter = GLES32.GL_LINEAR;
	/** Mag filter, default value is LINEAR. */
	public int magFilter = GLES32.GL_LINEAR;
	/** Default value is CLAMP_TO_EDGE. */
	public int wrapS = GLES32.GL_CLAMP_TO_EDGE;
	/** Default value is CLAMP_TO_EDGE. */
	public int wrapT = GLES32.GL_CLAMP_TO_EDGE;
	/** Default value is CLAMP_TO_EDGE. */
	public int wrapR = GLES32.GL_CLAMP_TO_EDGE;
	...
	public int hashCode() {
		...
		if(wrapR == GLES32.GL_CLAMP_TO_BORDER || wrapS == GLES32.GL_CLAMP_TO_BORDER || wrapT == GLES32.GL_CLAMP_TO_BORDER){
