...
import jet.learning.opengl.optimization.OptimizationApp;
...
//	        vec2f lowResTexelSize(1.f/lowResolution.x, 1.f/lowResolution.y);
        ...
        GLES20.glUniform2f(m_depthConstants, -1.f/ParticleUpsampling.EYE_ZFAR + 1.f/ParticleUpsampling.EYE_ZNEAR, -1.f/ParticleUpsampling.EYE_ZNEAR);
