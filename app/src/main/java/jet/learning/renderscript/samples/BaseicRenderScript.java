...
package jet.learning.renderscript.samples;
...
import com.example.oglsamples.ScriptC_saturation;

public class BaseicRenderScript extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int id = getApplicationContext().getResources().getIdentifier("saturation", "raw", getApplicationContext().getPackageName());
        Log.e("BaseicRenderScript", "id = " + id);
    ...
    private void createScript() {
        ...
        //Load script
        mScript = new ScriptC_saturation(mRS, getApplicationContext().getResources(), id);
    }
